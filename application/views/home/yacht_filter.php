                                    ...
                                    <form action="yachts" method="post">
                                        <div class="book-inner">
                                            ...
                                            <div class="inner-block second">
                                                <label></label>
                                                <select class="motor" name="yachtType" id="yachtType" onchange="getYachtDepartureCity('yachtCountry', 'yachtState', '1', 'yachtDays', 'yachtType', 'routeType');validateSuperYacht('yachtType','yachtDays');">
