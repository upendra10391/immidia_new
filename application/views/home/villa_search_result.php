    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function () {
                $("#modifyv").click(function () {
                    $(".tabbable-line").toggle("");
                    $('#tab_default_3_v').click();
            ...
            <div class="row">
                ...
                <div class="tabbable-line hide">
                    <ul class="nav nav-tabs ">
                        ...
                        <li class="option-tab">
                            <a href="#tab_default_4" data-toggle="tab" id="tab_default_3_v">
                                <img class="img-responsive" src="<?php echo base_url(); ?>assets/images/4.png"/> </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                               ...
                               <td><?php echo $villaFilterParams['villaDestinationName'];?></td>
        ...
        <div class="container-fluid result-list">
            <div class="row">
             ...
             foreach($villaList as $villaListData){?>
                ...
                <?php $arrVillaList[$villaListData->id] = $villaListData;}
               $_SESSION['villaList'] = $arrVillaList;
                ?>
        </div>
    </body>
