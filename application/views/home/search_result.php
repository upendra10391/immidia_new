            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="list-inner">
                        <img class="img-responsive" src="<?php echo base_url() ?>/assets/images/result1.jpg">
                        ...
                        <div class="hover-detail" >
                            ...
                            <a href="search.html">More Info</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="list-inner">
                        <img class="img-responsive" src="<?php echo base_url() ?>/assets/images/result3.jpg">
                        <div class="list-detail">
                            <h2>Arthuro</h2>
                            <ul>
                                <li>€ 2,250.00</li>
